...
try:
    # simple check for firefox in system, if not exists we just want non graphical tests....
    browser = webdriver.Firefox(executable_path='/usr/src/geo_exercise/geckodriver')
    ...
    class AccountTestCase(LiveServerTestCase):
        ...
        def setUp(self):
            self.selenium = webdriver.Firefox(executable_path='/usr/src/geo_exercise/geckodriver')  # home/na-simoes/Desktop/NunoSimoes/Softwares/geckodriver')
    ...
    class TestSignup(unittest.TestCase):
        ...
        def setUp(self):
            self.driver = webdriver.Firefox(executable_path='/usr/src/geo_exercise/geckodriver')
    ...
    logger.debug("Firefox isn't installed. Do you want execute just non graphical tests?")
